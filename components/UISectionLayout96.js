...
class UISectionLayout96 extends React.Component {
  render() {
    return (
      <section className="ui-section_layout96">
        <div className="ui-page-padding">
          <div className="ui-container-large">
            <div className="ui-padding-vertical-xhuge">
              <div className="ui-layout96_component">
                ...
                <div className="w-layout-grid ui-layout96_list">
...
export default UISectionLayout96;
