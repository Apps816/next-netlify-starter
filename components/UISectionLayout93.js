...
class UISectionLayout93 extends React.Component {
  render() {
    return (
      <section className="ui-section_layout93">
        <div className="ui-page-padding">
          <div className="ui-container-large">
            <div className="ui-padding-vertical-xhuge">
              <div className="ui-layout93_component">
                ...
                <div className="w-layout-grid ui-layout93_list">
...
export default UISectionLayout93;
