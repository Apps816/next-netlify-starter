...
class UISectionLayout65 extends React.Component {
  render() {
    return (
      <section className="ui-section_layout65">
        <div className="ui-page-padding">
          <div className="ui-container-large">
            <div className="ui-padding-vertical-xhuge">
              <div className="w-layout-grid ui-layout65_component">
                ...
                <div
                  className="ui-layout65_content"
                  id="w-node-_703f9a95-921f-4f82-3d7f-a5819f02c7e8-ac51cb5c"
                >
                  <div className="w-layout-grid ui-layout65_item-list">
                    <div className="ui-layout65_item">
                      ...
                      <div className="ui-button-row">
                        <a
                          ...
                          data-w-id="9d8e1e25-4066-3c7b-1b85-895c97226744"
                          href="#"
                        >
                          <div>Learn more</div>
...
export default UISectionLayout65;
