...
class UISectionLayout77 extends React.Component {
  render() {
    return (
      <section className="ui-section_layout77">
        <div className="ui-page-padding">
          <div className="ui-container-large">
            <div className="ui-padding-vertical-xhuge">
              <div className="ui-layout77_component">
                ...
                <div className="w-layout-grid ui-layout77_list">
...
export default UISectionLayout77;
