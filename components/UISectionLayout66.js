...
class UISectionLayout66 extends React.Component {
  render() {
    return (
      <section className="ui-section_layout66">
        <div className="ui-page-padding">
          <div className="ui-container-large">
            <div className="ui-padding-vertical-xhuge">
              <div className="w-layout-grid ui-layout66_component">
                ...
                <div
                  className="ui-layout66_content"
                  id="w-node-e6bafc4c-5010-7df0-d56b-eb4ed1e041f0-ac51cb5c"
                >
                  <div className="w-layout-grid ui-layout66_item-list">
                    <div
                      className="ui-layout66_item"
                      id="w-node-e6bafc4c-5010-7df0-d56b-eb4ed1e041f2-ac51cb5c"
                    >
                      <div className="ui-layout66_item-icon-wrapper">
                      ...
                      <div className="ui-layout66_item-text-wrapper">
                    ...
                    <div
                      className="ui-layout66_item"
                      id="w-node-e6bafc4c-5010-7df0-d56b-eb4ed1e041fc-ac51cb5c"
                    >
                      <div className="ui-layout66_item-icon-wrapper">
                        <div className="ui-icon-featured-outline-large">
                          <div className="ui-icon-1x1-xsmall w-embed">
                    ...
                    <div
                      className="ui-layout66_item"
                      id="w-node-e6bafc4c-5010-7df0-d56b-eb4ed1e04206-ac51cb5c"
                    >
                      <div className="ui-layout66_item-icon-wrapper">
                        <div className="ui-icon-featured-outline-large">
                          <div className="ui-icon-1x1-xsmall w-embed">
...
export default UISectionLayout66;
