...
class UISectionLayout79 extends React.Component {
  render() {
    return (
      <section className="ui-section_layout79">
        <div className="ui-page-padding">
          <div className="ui-container-large">
            <div className="ui-padding-vertical-xhuge">
              <div className="ui-layout79_component">
                ...
                <div className="w-layout-grid ui-layout79_list">
...
export default UISectionLayout79;
