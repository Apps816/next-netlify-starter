...
class UISectionLayout16 extends React.Component {
  render() {
    return (
      <section className="ui-section_layout16">
        <div className="ui-page-padding">
          <div className="ui-container-large">
            <div className="ui-padding-vertical-xhuge">
              <div className="w-layout-grid ui-layout16_component">
                <div className="ui-layout16_content">
                  <div className="w-layout-grid ui-layout16_item-list">
                    <div className="ui-layout16_item">
...
export default UISectionLayout16;
