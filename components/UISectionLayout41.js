...
class UISectionLayout41 extends React.Component {
  render() {
    return (
      <section className="ui-section_layout41">
        <div className="ui-page-padding">
          <div className="ui-container-large">
            <div className="ui-padding-vertical-xhuge">
              <div className="ui-layout42_component">
...
export default UISectionLayout41;
