...
class UISectionLayout82 extends React.Component {
  render() {
    return (
      <section className="ui-section_layout82">
        <div className="ui-page-padding">
          <div className="ui-container-large">
            <div className="ui-padding-vertical-xhuge">
              <div className="w-layout-grid ui-layout82_component">
                <div
                ...
                <div className="w-layout-grid ui-layout82_list">
...
export default UISectionLayout82;
