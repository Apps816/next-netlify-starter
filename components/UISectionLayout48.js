...
class UISectionLayout48 extends React.Component {
  render() {
    return (
      <section className="ui-section_layout48">
          ...
          <div className="ui-container-large">
            <div className="ui-padding-vertical-xhuge">
              <div className="ui-text-align-center">
                <div className="ui-max-width-medium align-center">
...
export default UISectionLayout48;
