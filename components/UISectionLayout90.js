...
class UISectionLayout90 extends React.Component {
  render() {
    return (
      <section className="ui-section_layout90">
        <div className="ui-page-padding">
          <div className="ui-container-large">
            <div className="ui-padding-vertical-xhuge">
              <div className="ui-layout90_component">
                ...
                <div className="w-layout-grid ui-layout90_list">
                  <div className="ui-layout90_item">
...
export default UISectionLayout90;
