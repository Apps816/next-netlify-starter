...
class UISectionLayout78 extends React.Component {
  render() {
    return (
      <section className="ui-section_layout78">
        <div className="ui-page-padding">
          <div className="ui-container-large">
            <div className="ui-padding-vertical-xhuge">
              <div className="ui-layout78_component">
                ...
                <div className="w-layout-grid ui-layout78_list">
...
export default UISectionLayout78;
