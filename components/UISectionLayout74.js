...
class UISectionLayout74 extends React.Component {
  render() {
    return (
      <section className="ui-section_layout74">
        <div className="ui-page-padding">
          <div className="ui-container-large">
            <div className="ui-padding-vertical-xhuge">
              <div className="ui-layout74_component">
                ...
                <div className="w-layout-grid ui-layout74_list">
                  <div className="ui-layout74_item">
...
export default UISectionLayout74;
