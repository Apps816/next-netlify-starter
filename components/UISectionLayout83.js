...
class UISectionLayout83 extends React.Component {
  render() {
    return (
      <section className="ui-section_layout83">
        <div className="ui-page-padding">
          <div className="ui-container-large">
            <div className="ui-padding-vertical-xhuge">
              <div className="w-layout-grid ui-layout83_component">
                <div
                ...
                <div className="w-layout-grid ui-layout83_list">
...
export default UISectionLayout83;
