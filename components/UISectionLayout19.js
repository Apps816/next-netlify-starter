...
class UISectionLayout19 extends React.Component {
  render() {
    return (
      <section className="ui-section_layout19">
        <div className="ui-page-padding">
          <div className="ui-container-large">
            <div className="ui-padding-vertical-xhuge">
              <div className="w-layout-grid ui-layout19_component">
                <div className="ui-layout19_content">
                  <div className="w-layout-grid ui-layout19_item-list">
                    <div
                      className="ui-layout19_item"
                      id="w-node-_6a45719c-29d4-ed15-04c9-956e3783c37e-ac51cb5c"
                    >
                      <div className="ui-layout19_item-icon-wrapper">
                      ...
                      <div className="ui-layout19_item-text-wrapper">
                        ...
                        <div className="ui-button-row">
                          <a
                            ...
                            data-w-id="005eb4f4-59ed-eaf8-f1b4-5b5a75de984b"
                            href="#"
                          >
                            <div>Learn more</div>
                            <div className="ui-button-icon w-embed">
                              <svg
                                fill="CurrentColor"
                                height={12}
                                viewBox="0 0 14.99 22.62"
                                width={9}
                                xmlns="http://www.w3.org/2000/svg"
                              >
                                <path
                                  d="M15 11l-3.93 3.58c-3 2.25-9.85 7.3-10 7.49l-1 .59v-2l.54-.69c2.1-2.65 4.79-5.55 7.66-9L5.94 8C3.65 5 3.43 3.44.85 0c0 0 8 5.6 10.32 7.31z"
                                  stroke="CurrentColor"
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
                                  strokeWidth="1.67"
                    ...
                    <div
                      className="ui-layout19_item"
                      id="w-node-_6a45719c-29d4-ed15-04c9-956e3783c38e-ac51cb5c"
                    >
                      <div className="ui-layout19_item-icon-wrapper">
                        <div className="ui-icon-featured-outline-large">
                          <div className="ui-icon-1x1-xsmall w-embed">
                    ...
                    <div
                      className="ui-layout19_item"
                      id="w-node-_6a45719c-29d4-ed15-04c9-956e3783c39e-ac51cb5c"
                    >
                      <div className="ui-layout19_item-icon-wrapper">
                        <div className="ui-icon-featured-outline-large">
                          <div className="ui-icon-1x1-xsmall w-embed">
                ...
                <div className="ui-layout17_image-wrapper">
                  <img
                    alt="Credit card mockups"
                    className="ui-layout17_image"
                    loading="lazy"
...
export default UISectionLayout19;
