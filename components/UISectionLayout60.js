...
class UISectionLayout60 extends React.Component {
  render() {
    return (
      <section className="ui-section_layout60">
        <div className="ui-page-padding">
          <div className="ui-container-large">
            <div className="ui-padding-vertical-xhuge">
              <div className="w-layout-grid ui-layout60_component">
...
export default UISectionLayout60;
