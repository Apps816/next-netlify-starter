...
class UISectionLayout14 extends React.Component {
  render() {
    return (
      <section className="ui-section_layout14">
        <div className="ui-page-padding">
          <div className="ui-container-large">
            <div className="ui-padding-vertical-xhuge">
              <div className="w-layout-grid ui-layout14_component">
                <div className="ui-layout14_content">
                  <div className="w-layout-grid ui-layout14_item-list">
...
export default UISectionLayout14;
