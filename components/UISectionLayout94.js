...
class UISectionLayout94 extends React.Component {
  render() {
    return (
      <section className="ui-section_layout94">
        <div className="ui-page-padding">
          <div className="ui-container-large">
            <div className="ui-padding-vertical-xhuge">
              <div className="ui-layout94_component">
                ...
                <div className="w-layout-grid ui-layout94_list">
                  <div className="ui-layout78_item">
                    <div className="ui-layout78_item-content">
...
export default UISectionLayout94;
