...
class UISectionLayout63 extends React.Component {
  render() {
    return (
      <section className="ui-section_layout63">
        <div className="ui-page-padding">
          <div className="ui-container-large">
            <div className="ui-padding-vertical-xhuge">
              <div className="w-layout-grid ui-layout63_component">
                <div className="ui-layout49_image-wrapper">
                  <img
                    alt="Dashboard mockup"
                    className="ui-layout49_image shadow-xlarge"
                    loading="lazy"
                ...
                <div
                  className="ui-layout63_content"
                  id="w-node-fc9bc6d6-2bde-1277-8112-49687689036d-ac51cb5c"
                >
                  <div className="w-layout-grid ui-layout63_item-list">
...
export default UISectionLayout63;
